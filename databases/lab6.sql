...
-- 2 Добавление полей, для которых используются ограничения (CHECK), значения по умолчанию (DEFAULT), встроенные функции для вычисления значений --
USE lab6;
GO 
...
CREATE TABLE Orders (
	...
	--ON DELETE NO ACTION -- по дефолту  и (Если связанных строк нет, то удаление будет выполнено)
);
GO
